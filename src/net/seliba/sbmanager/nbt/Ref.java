...
//					System.out.println("it was null");
        ...
        private static final Constructor<?> NBT_TAG_COMPOUND_CONSTRUCTOR = getConstructor(CLASS_NBT_TAG_COMPOUND);
...
//				return CLASS_NBT_TAG_COMPOUND.newInstance();
        ...
        private static final Method NMS_ITEM_FROM_NBT_METHOD = getDesiredMethod(CLASS_NMS_ITEM_STACK, CLASS_NMS_ITEM_STACK, params(CLASS_NBT_TAG_COMPOUND));
        ...
        private static final Method SAVE_NMS_ITEM_TO_NBT = getMethod(CLASS_NMS_ITEM_STACK, "save", CLASS_NBT_TAG_COMPOUND);
        ...
        private static final Method SET_BASE_METHOD = getMethod(CLASS_NBT_TAG_COMPOUND, "set", String.class, CLASS_NBT_TAG_BASE);
        ...
        private static final Method GET_LIST_METHOD = getMethod(CLASS_NBT_TAG_COMPOUND, "getList", String.class, Integer.TYPE);
        ...
        private static final Method GET_LIST_STRING_METHOD = getMethod(CLASS_NBT_LIST, "getString", Integer.TYPE);
...
//                return (int) GET_LIST_INT_METHOD.invoke(nbtList, i);
        ...
        private static final Method GET_LIST_DOUBLE_METHOD = getDesiredMethod(CLASS_NBT_LIST, Double.TYPE, params(Integer.TYPE));
        ...
        private static final Method GET_LIST_FLOAT_METHOD = getDesiredMethod(CLASS_NBT_LIST, Float.TYPE, params(Integer.TYPE));
        ...
        private static final Method GET_LIST_COMPOUND_METHOD = getDesiredMethod(CLASS_NBT_LIST, CLASS_NBT_TAG_COMPOUND, params(Integer.TYPE));
        ...
        private static final Method CREATE_BASE_METHOD = getMethod(CLASS_NBT_TAG_BASE, "createTag", Byte.TYPE);
        ...
        private static final Method NBT_LIST_ADD_METHOD = getMethod(CLASS_NBT_LIST, "add", CLASS_NBT_TAG_BASE);
        ...
        private static Method getDesiredMethod(Class<?> clazz, Class<?> returnType, Class<?>[] parameters) {
...
//                        System.out.println("HELL YES: Returning:" + meth);
        ...
        private static final Class<?> CLASS_NBT_COMPRESSED_STREAM_TOOLS = getNMS("NBTCompressedStreamTools");
        private static final Method WRITE_TO_STREAM = getMethod(CLASS_NBT_COMPRESSED_STREAM_TOOLS, "a", CLASS_NBT_TAG_COMPOUND, OutputStream.class);
        ...
        private static final Method READ_FROM_STREAM_METHOD = getMethod(CLASS_NBT_COMPRESSED_STREAM_TOOLS, "a", InputStream.class);
...
//					System.out.println("THE METHOD:" + TILE_ENTITY_CHEST_SET_NAME);
    ...
    public static class EnderEye {
        ...
        private final static Constructor<?> CONSTRUCTOR_BLOCK_POSITION = getConstructor(CLASS_BLOCK_POSITION, params(Integer.TYPE, Integer.TYPE, Integer.TYPE));
        private final static Method METHOD_ENDER_SIGNAL_SET_TARGET = getMethod(CLASS_ENDER_SIGNAL, "a", params(CLASS_BLOCK_POSITION)),
                METHOD_CRAFT_ENDER_SIGNAL_HANDLE = getMethod(CLASS_CRAFT_ENDER_SIGNAL, "getHandle");
        private final static Field FIELD_ENDER_SIGNAL_NO_DROP = getField(CLASS_ENDER_SIGNAL, "e") != null ? getField(CLASS_ENDER_SIGNAL, "e") :
