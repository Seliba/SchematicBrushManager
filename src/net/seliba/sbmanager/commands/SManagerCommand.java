...
import net.seliba.sbmanager.guis.schematics.SchematicCreateGUI;
import net.seliba.sbmanager.guis.schematics.SchematicGUI;
    ...
    if (sender instanceof Player) {
      ...
      if (player.hasPermission("sbmanager.schematics")) {
        ...
        File publicDirectory = new File(
            "../SBManager/schematics/" + player.getUniqueId().toString() + "/");
        try {
          ...
          Bukkit.getLogger()
              .log(Level.WARNING, player.getName() + " konnte ein Schematic nicht empfangen. " +
